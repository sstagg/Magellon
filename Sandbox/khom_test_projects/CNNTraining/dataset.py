...
class JPGPreprocessor:
    ...
    def process_particle_images(jpg_dir, metadata_dir, job_id, label_df, hdf5_dataset=None, out_data_dir=None, resize=None, min_len=None, fixed_len=None):
        ...
        for i, img in enumerate(imgs):
            ...
            if resize is not None:
                img = resize_img(np.nan_to_num(img), pixel_size/resize)
    ...
    def calculate_class_scores(label_df, metadata, job_id):
        ...
        weight = ((est_res.min() / est_res) ** 2).rename('weight')
    ...
    def process_particle_images(particle_name, data_dir, hdf5_dataset=None, out_data_dir=None, resize=False, min_len=None, fixed_len=None):
        ...
        if os.path.isdir(os.path.dirname(mrc_full_path)):
            with mrcfile.open(mrc_full_path) as mrc:
                ...
                mass_est = mass_est.drop(columns=['mass'])
                ...
                for i, img in enumerate(imgs):
                    ...
                    if resize:
                        img = resize_img(np.nan_to_num(img), pixel_size/PIXEL_SIZE)
...
class MRCImageDataset(Dataset):
    def __init__(self, mode=None, annotations_file=None, 
        ...
        # self.metadata_names = ['est_res', 'class_dist', 'pixel_size']
...
if __name__ == '__main__':
    ...
    hdf5_path = '/nfs/home/khom/test_projects/ClassAvgLabeling/ProcessedData/processed_stagg_vlen.hdf5'
    ...
    hdf5_path = '/nfs/home/khom/test_projects/ClassAvgLabeling/ProcessedData/processed_lander_vlen.hdf5'
    ...
    hdf5_path = '/nfs/home/khom/test_projects/ClassAvgLabeling/ProcessedData/processed_cianfrocco_vlen.hdf5'
    ...
    paths = [
        '/nfs/home/khom/test_projects/ClassAvgLabeling/ProcessedData/processed_lander_vlen.hdf5',
        '/nfs/home/khom/test_projects/ClassAvgLabeling/ProcessedData/processed_stagg_vlen.hdf5',
        '/nfs/home/khom/test_projects/ClassAvgLabeling/ProcessedData/processed_cianfrocco_vlen.hdf5'
    ]
    combine_hdf5(paths, '/nfs/home/khom/test_projects/ClassAvgLabeling/ProcessedData/alldata_vlen.hdf5', fixed_len=fixed_len)
