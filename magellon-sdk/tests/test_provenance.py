"""Tests for plugin provenance fields on TaskResultMessage (P4).
...
def test_provenance_fields_default_to_none():
    ...
    must still produce a valid TaskResultMessage."""
    r = TaskResultMessage(task_id=uuid4(), code=200, message="ok")
