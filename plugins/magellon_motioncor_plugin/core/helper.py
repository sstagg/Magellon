...
from magellon_sdk.models import CryoEmMotionCorTaskData, TaskDto, TaskResultDto
...
def parse_json_for_cryoemctftask(message_str):
    return CryoEmMotionCorTaskData.model_validate(
        TaskDto.model_validate_json(message_str).data
    )
